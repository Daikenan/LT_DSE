...
def show_res(im, box, win_name,confidence=None,score=None,save_path=None,frame_id=None,mask=None,score_max=None, groundtruth=None, can=None, local_state=None, rtbox=None):
    ...
    if confidence is not None:
        cv2.putText(im, 'confidence:'+str(round(confidence, 2)), (20, 120), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 255), 2)
    if frame_id is not None:
        cv2.putText(im,'frame:'+str(frame_id),(20,50), cv2.FONT_HERSHEY_SIMPLEX,2,(0,255,255),2)
